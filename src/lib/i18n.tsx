...
export const translations = {
  en: {
    ...
    signInToUpload: 'Sign in with Google to Upload Images',
    signInToUploadDesc: 'Please sign in with your Google account to compress and optimize your images.',
    continueWithGoogle: 'Continue with Google',
    readyToUpload: 'file(s) ready to upload',
  ...
  'fr-CA': {
    ...
    signInToUpload: 'Connectez-vous avec Google pour téléverser des images',
    signInToUploadDesc: 'Veuillez vous connecter avec votre compte Google pour compresser et optimiser vos images.',
    continueWithGoogle: 'Continuer avec Google',
    readyToUpload: 'fichier(s) prêt(s) au téléversement',
  ...
  ar: {
    ...
    signInToUpload: 'سجل الدخول باستخدام Google لرفع الصور',
    signInToUploadDesc: 'يرجى تسجيل الدخول باستخدام حساب Google الخاص بك لضغط وتحسين صورك بأمان.',
    continueWithGoogle: 'المتابعة باستخدام Google',
    readyToUpload: 'ملف جاهز للرفع',
  ...
  ur: {
    ...
    signOut: 'سائن آؤٹ',
    signedInAs: 'بطور سائن ان ہیں',
    googleAccount: 'گوگل اکاؤنٹ',
    myAccount: 'میرا اکاؤنٹ',
    connecting: 'سائن ان ہو رہا ہے...',
    signInToUpload: 'تصاویر اپ لوڈ کرنے کے لیے Google سے سائن ان کریں',
    signInToUploadDesc: 'تصاویر کو کمپریس اور آپٹیمائز کرنے کے لیے براہ کرم اپنے گوگل اکاؤنٹ سے سائن ان کریں۔',
    continueWithGoogle: 'Google کے ساتھ آگے بڑھیں',
    readyToUpload: 'فائلیں اپ لوڈ کے لیے تیار ہیں',
  ...
  ru: {
    ...
    connecting: 'Вход...',
    signInToUpload: 'Войдите через Google для загрузки',
    signInToUploadDesc: 'Пожалуйста, войдите в аккаунт Google, чтобы сжимать и оптимизировать изображения.',
    continueWithGoogle: 'Продолжить с Google',
    readyToUpload: 'файл(ов) готово к загрузке',
